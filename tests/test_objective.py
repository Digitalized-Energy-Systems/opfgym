...
def test_get_powers_from_pwl_cost(net):
    ...
    net.res_load['p_mw'][0] = 1.5
    net.res_load['q_mvar'][0] = 2.0
    ...
    net.res_sgen['p_mw'][0] = 1.2
    net.res_gen['p_mw'][0] = 1.4
...
def test_get_polynomial_costs(net):
    ...
    net.poly_cost['cp0_eur'][0] = 1
    net.poly_cost['cq2_eur_per_mvar2'][1] = 2
